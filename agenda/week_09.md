...
**Welcome to Month 3: Intelligence!** You've mastered RAG and security. Now AI gets powerful — it will take actions in the real world.

So far your AI can only talk. This week you'll teach it to **take actions** — search the web, query databases, send emails, and more. This is called **tool calling** and it's how AI goes from chatbot to useful assistant.
...
Next week: **Agentic AI** — AI that can plan, reason, and execute multi-step tasks autonomously!
