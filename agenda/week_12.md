...
# MCP servers are provider-agnostic — the same server works with any AI client
```

> MCP servers you build this week work with any MCP-compatible AI client, whether it uses OpenAI or a local Ollama model.
