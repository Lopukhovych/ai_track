# Week 11: Data Engineering for AI + Portfolio Project #2
...
```bash
ollama pull qwen2.5-coder:7b   # ~4.7GB — trained on code, excels at SQL generation
ollama pull llama3.1:8b        # general analysis tasks
```

```python
from scripts.model_config import get_client, CODE_MODEL, CHAT_MODEL
# Use CODE_MODEL for SQL generation, CHAT_MODEL for data analysis
```
